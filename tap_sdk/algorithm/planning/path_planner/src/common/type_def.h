...
#include "path_planner/src/common/constants.h"
#include "path_planner/src/math/vec2d.h"
#include "path_planner/src/math/vec3d.h"
...
enum PlanResult {
    ...
    PLAN_MSG_E2E_PLANNING_TIMEOUT = 210
...
enum LcReason {
    ...
    LC_REASON_FOR_AVOID_MULTI_DIR = 14
};
...
struct EntryFuncSmoothInfo {
    bool is_entry_func_need_smooth = false;
    uint64_t step = 1;
};

enum BorrowDirection { BORROW_DIRECTION_LEFT = 0, BORROW_DIRECTION_RIGHT = 1 };
}  // namespace planning
}  // namespace ads_x
