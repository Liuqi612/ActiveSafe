...
class SegmentMatcher {
 public:
    ...
    bool GetNearestSegmentIdWithHeading(double x,
                                        double y,
                                        double theta,
                                        double max_radius,
                                        double max_heading_diff,
    ...
    virtual bool GetNearestSegmentId(double x,
                                     double y,
                                     std::string *id) const = 0;

    virtual std::vector<std::string> GetSegmentIdInRadius(double x,
                                                          double y,
                                                          double r) const = 0;

    virtual bool GetNearestSegmentIndex(double x,
                                        double y,
                                        int *index) const = 0;

    virtual std::vector<int> GetSegmentIndexInRadius(double x,
                                                     double y,
                                                     double r) const = 0;

    virtual const Segment2d *GetNearestSegment(double x, double y) const = 0;

    virtual std::vector<const Segment2d *> GetSegmentInRadius(
        double x, double y, double r) const = 0;

    virtual bool GetNearestNamedSegment(double x,
                                        double y,
                                        Segment2d *seg,
                                        std::string *id) const = 0;
