...
class AffineTransformation {
 public:
    ...
    static AffineTransformation FromRotation(double theta,
                                             double ax,
                                             double ay,
                                             double az);
    ...
    static AffineTransformation FromYawPitchRoll(double yaw,
                                                 double pitch,
                                                 double roll);
    ...
    static AffineTransformation FromRotationProto(
    ...
    static AffineTransformation FromExtrinsics(
    ...
    AffineTransformation &SetRotation(double theta,
                                      double ax,
                                      double ay,
                                      double az);
    ...
    AffineTransformation &SetYawPitchRoll(double yaw,
                                          double pitch,
                                          double roll);
    ...
    AffineTransformation &ApplyRotation(double theta,
                                        double ax,
                                        double ay,
                                        double az);
    ...
    AffineTransformation &ApplyYawPitchRoll(double yaw,
                                            double pitch,
                                            double roll);
    ...
    Vec4d Transform(const Vec4d &x) const;
