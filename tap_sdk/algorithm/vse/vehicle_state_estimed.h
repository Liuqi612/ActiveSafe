#ifndef TAP_SDK_ALGORITHM_VSE_VEHICLE_STATE_ESTIMED_H_
#define TAP_SDK_ALGORITHM_VSE_VEHICLE_STATE_ESTIMED_H_
#include "Eigen/Dense"
...
class VehicleStateEstimed {
  public:
    ...
    void Init();
    void Run(const VseInput &vse_input, uint64_t curtime, const GlobalConfig &config);
...
#endif // TAP_SDK_ALGORITHM_VSE_VEHICLE_STATE_ESTIMED_H_
